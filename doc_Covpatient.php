...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>YOUR HOSPITAL-Covid Patient</title>
    <style>
      body{
        color: rgb(0,120,120);
        /* margin-left: 10%; */
  ...
  <body>
    ...
    $sql1 = "SELECT * FROM patient where covid='+ve' or covid='-ve';";
    ...
    if ($result->num_rows > 0) {
      ...
      <caption> Patient Record with COVID-19 Test</caption>
      <tr><th>Addhar no</th><th>Name</th><th>Age</th><th>Gender</th><th>COVID-19</th><th>Test</th><th>Email</th></tr>
      <?php
      ...
      <br>
        ...
        ?>
        <br><br><br>
        <p align="center">There is <font color='red'>no patient who has done COVID-19 test</font>.</p>
        <br><br><br>
        <?php
      }
    ?>
