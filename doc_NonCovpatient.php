...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>YOUR PATIENT-Patient Record Without Test</title>
    <style>
      body{
        color: rgb(0,120,120);
        /* margin-left: 10%; */
  ...
  <body>
    ...
    $sql1 = "SELECT * FROM patient where covid='ntd';";
    ...
    if ($result->num_rows > 0) {
      ...
      <caption> Patient Record Without COVID-19 Test</caption>
      <tr><th>Addhar no</th><th>Name</th><th>Age</th><th>Gender</th><th>Address</th><th>Test</th><th>Email</th></tr>
      <?php
      ...
      <script type="text/javascript">
        ...
        ?>
        <br><br><br><br>
        <p align="center">There is no patient without <font color="red">COVID-19</font> test.</p>
        <br><br>
        <button type="button" name="button" onclick="goBack()" style="background: yellow;
                                                                      border-radius: 10px;
                                                                      margin-bottom: 5%;
