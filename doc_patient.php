...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>YOUR HOSPITAL-Your Patient</title>
    <style>
      body{
        color: rgb(0,120,120);
        /* margin-left: 10%; */
  ...
  <body>
    ...
    $sql1 = "SELECT * FROM patient natural JOIN doctor where doctor.email='".$email."';";
    ...
    if ($result->num_rows > 0) {
      ...
      <caption>Patient Records Under You Supervision</caption>
      <tr><th>Addhar no</th><th>Name</th><th>Age</th><th>Address</th><th>Test</th><th>Email</th></tr>
      <?php
        ...
        ?>
        <br><br><br>
        <p align="center">There is no patient under you.</p>
        <br>
        <?php
      }
    ?>
