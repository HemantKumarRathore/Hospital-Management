...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>YOUR HOSPITAL-Patient Hospitalization Form</title>
    <style>
      body{
        color: rgb(0,120,120);
        /* margin-left: 10%; */
  ...
  <body>
    ...
    <div class="form">
      <form class="" action="staff_hospitalise_patient_inter.php" method="post">
        <h1 align="center">Patient Hospitalization Form</h1>
        ...
        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp;
        <input type="text" name="bedID" value="">
        <br><br>
        <label for="charges">Hospitalise Charge:</label>
        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
      ...
      <?php
        while($row = $result->fetch_assoc()) {
          ...
          <tr>
            ...
            <td><?php echo $row["t_general"]; ?></td>
            <td><?php echo $row["o_general"]; ?></td>
            <td><?php echo $row["t_general"]-$row["o_general"]; ?></td>
            <td><?php echo $row["icu_id"]; ?></td>
            <td><?php echo $row["t_icu"]; ?></td>
            <td><?php echo $row["o_icu"]; ?></td>
            <td><?php echo $row["t_icu"]-$row["o_icu"]; ?></td>
          </tr>
          <?php
        }
        ?>
